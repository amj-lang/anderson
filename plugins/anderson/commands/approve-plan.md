...
1. Print: `▶ [anderson 3/4 · IMPLEMENT] agent=implementer · model=sonnet · effort=medium · executing plan.md`
...
2. Print: `▶ [anderson 4/4 · DIFF-REVIEW] agent=reviewer · model=opus · effort=xhigh · read-only diff review`
