...
case "$stage" in
  plan)        persona="THE ARCHITECT"; agent="planner";       spec="opus · medium";   act="scoping → plan.md";         n="1/4"; mood="design";;
  plan_review) persona="THE ORACLE";    agent="plan-reviewer";  spec="opus · high+";    act="editing plan.md";           n="2/4"; mood="insight";;
  ...
  diff_review) persona="AGENT SMITH";   agent="reviewer";       spec="opus · high+";    act="read-only diff review";     n="4/4"; mood="adversary";;
